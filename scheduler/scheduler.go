...
import (
	...
	"github.com/OldBigBuddha/mini-kube-scheduler/minisched"
	...
	"github.com/OldBigBuddha/mini-kube-scheduler/scheduler/plugin"
)
...
func (s *Service) StartScheduler(versionedcfg *v1beta2config.KubeSchedulerConfiguration) error {
	...
	if err != nil {
		cancel()
		return fmt.Errorf("failed to initialize minisched: %w", err)
	}
